                      ...
                      child: Form(
                        ...
                        child: ListView(
                          children: [
                                ...
                                child: Ink(
                                  ...
                                  child: Center(
                                    child: isLoading
                                        ...
                                        : const Text('دخول', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
                                  ),
                                ),
                              ),
                            ),
                            const SizedBox(height: 14),
                            TextButton(
                              onPressed: isLoading ? null : () => Navigator.pushReplacementNamed(context, '/signup'),
                              child: const Text('ليس لديك حساب؟ سجل الآن', style: TextStyle(color: Colors.white70)),
                            ),
                          ],
                        ),
                      ),
