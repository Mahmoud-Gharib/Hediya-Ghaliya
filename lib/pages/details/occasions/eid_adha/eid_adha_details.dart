...
/// توليد صفحات مناسبة "عيد الأضحى"
List<Map<String, dynamic>> generateEidAdhaPages(Gift g) {
  ...
  return [
    pageSpec(
      ...
      title: 'الغلاف',
      blocks: [
        textBlock('عيد أضحى مبارك', style: const {'align': 'center', 'size': 28, 'weight': 'bold'}),
        textBlock('إلى $recipientName', style: const {'align': 'center', 'size': 20}),
        textBlock('من: $senderName', style: const {'align': 'center', 'size': 14}),
      ],
    ),
    pageSpec(
      id: 'dedication_eid_adha_1',
      type: 'dedication',
      title: 'الإهداء',
      blocks: [
        quoteBlock('تقبل الله طاعتكم وكل عام وأنتم بخير.'),
      ],
    ),
    pageSpec(
      id: 'message_eid_adha_1',
      type: 'message',
      title: 'رسالة',
      blocks: [
        textBlock('نسأل الله لكم فرحًا وسرورًا في هذا العيد.'),
      ],
    ),
    pageSpec(
      id: 'photos_eid_adha_1',
      type: 'photos',
      title: 'صور',
      blocks: [
        imageBlock(''),
